...
from EfficientHRNet.EfficientHRNet_Main import get_pose_net
from EfficientHRNet.lib.core.group import HeatmapParser
from EfficientHRNet.lib.utils.inference import get_outputs
from EfficientHRNet.lib.utils.transforms import get_final_preds
from EfficientHRNet.lib.utils.transforms import resize

from sklearn.ensemble import IsolationForest
import numpy as np
from EfficientHRNet.DetectionRegresser import DetectionRegresser
...
class EfficientHRNetKeypoints:
    def __init__(self, pose_cfg,defaults_dict):
        ...
        self.net.load_state_dict(torch.load(self.pose_cfg.TEST.MODEL_FILE, map_location='cpu'), strict=True)
        self.net.eval()
        self.eval_set = 2
        # self.net.cuda()
        self.d = dict()
